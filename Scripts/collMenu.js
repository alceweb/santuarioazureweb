...
if (document.getElementById) {
  ...
  document.writeln('.main {text-decoration:none; font-family:Times New Roman; color:navy; cursor:hand; cursor:pointer}')
  document.writeln('span:hover.mainLink {text-decoration:underline; color:red}')
  document.writeln('.sublinks1 {display:none; padding-left:16px}')
  document.writeln('.link2 {text-decoration:none; color:navy}')
  ...
  var subNum1 = new Array("b1","b2","b3");
  ...
  for(var i=0; i < menuArray.length; i++) {
    if (menuArray[i] == theID) {
      if (document.getElementById(theID).style.display == "block") {
        ...
        //document.getElementById("tick_" + menuArray[i]).innerHTML = "<strong>+</strong>";
        eraseCookie(theName); }
      else {
...
function memStatus() {
  ...
  if (num) {
    ...
    //document.getElementById("tick_" + num).innerHTML = "<strong>-</strong>";
}
  var num1 = readCookie("SB");
  if (num1) {
    document.getElementById(num1).style.display = "block";
    //document.getElementById("tick_" + num1).innerHTML = "<strong>+</strong>";
}
}
